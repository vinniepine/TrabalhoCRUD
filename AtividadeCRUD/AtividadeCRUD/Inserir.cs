...
public partial class Inserir : Form
{
    ...
    private void txtAliq_KeyUp(object sender, KeyEventArgs e)
    {
        ...
        {
            MessageBox.Show(ex.Message, "IFRO; Ji-Paraná", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
    ...
    private void btCreate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (FulfilledBoxes())
            {
                ...
                dDAO.Insert(d);
                MessageBox.Show("Item Cadastrado com sucesso!", "IFRO; Ji-Paraná", MessageBoxButtons.OK, MessageBoxIcon.Information);
