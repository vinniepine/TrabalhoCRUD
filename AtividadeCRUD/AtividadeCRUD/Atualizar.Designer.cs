...
partial class Atualizar
{
    ...
    private void InitializeComponent()
    {
        ...
        lbl4.TabIndex = 0;
        lbl4.Text = "Atualização de cadastro de dispositivos";
        ...
        btVoltar.Location = new Point(246, 474);
        ...
        txtDescricao.Location = new Point(387, 367);
        ...
        btUpdate.Location = new Point(387, 474);
        ...
        txtAliq.Location = new Point(387, 317);
        ...
        lblDescricao.Location = new Point(246, 365);
        ...
        cbStatus.Location = new Point(387, 417);
        ...
        lblStatus.Location = new Point(246, 416);
        ...
        lblFee.Location = new Point(246, 315);
        lblFee.Name = "lblFee";
        ...
        // lblHeadger
        // 
        lblHeadger.Font = new Font("Agency FB", 21.75F, FontStyle.Regular, GraphicsUnit.Point, 0);
        lblHeadger.ForeColor = SystemColors.ButtonHighlight;
        lblHeadger.Location = new Point(-3, 136);
        lblHeadger.Name = "lblHeadger";
        lblHeadger.Size = new Size(824, 84);
        lblHeadger.TabIndex = 27;
        lblHeadger.Text = "Preencha apenas os campos que deseja atualizar.  Campos deixados em branco permanecerão com os mesmos dados presentes no cadastro.";
