...
partial class Atividade
{
    ...
    private void InitializeComponent()
    {
        ...
        btCreate.Location = new Point(318, 303);
        btCreate.Name = "btCreate";
        btCreate.Size = new Size(180, 50);
        btCreate.TabIndex = 4;
        ...
        btList.Location = new Point(318, 359);
        btList.Name = "btList";
        btList.Size = new Size(180, 50);
        btList.TabIndex = 5;
        ...
        btUpdate.Location = new Point(318, 471);
        btUpdate.Name = "btUpdate";
        btUpdate.Size = new Size(180, 50);
        btUpdate.TabIndex = 6;
        ...
        btDelete.Location = new Point(318, 415);
        btDelete.Name = "btDelete";
        btDelete.Size = new Size(180, 50);
        btDelete.TabIndex = 7;
        ...
        // lblEnunciate
        // 
        lblEnunciate.Font = new Font("Agency FB", 21.75F, FontStyle.Regular, GraphicsUnit.Point, 0);
        lblEnunciate.ForeColor = SystemColors.ButtonFace;
        lblEnunciate.Location = new Point(100, 119);
        lblEnunciate.Name = "lblEnunciate";
        lblEnunciate.Size = new Size(624, 181);
