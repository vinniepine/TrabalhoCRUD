...
CREATE TABLE `despesa` (
  ...
  `fk_id_fornecedor` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `fk_id_caixa` (`fk_id_caixa`),
  KEY `fk_fornecedor` (`fk_id_fornecedor`),
  CONSTRAINT `despesa_ibfk_1` FOREIGN KEY (`fk_id_caixa`) REFERENCES `caixa` (`id`),
  CONSTRAINT `fk_fornecedor` FOREIGN KEY (`fk_id_fornecedor`) REFERENCES `fornecedor` (`id`)
