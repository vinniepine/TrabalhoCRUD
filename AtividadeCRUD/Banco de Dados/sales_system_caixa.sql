...
CREATE TABLE `caixa` (
  ...
  `total_saida` double DEFAULT NULL,
  `status_caixa` tinyint(1) DEFAULT NULL,
  `fk_id_funcionario` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_id_funcionario` (`fk_id_funcionario`),
  CONSTRAINT `caixa_ibfk_1` FOREIGN KEY (`fk_id_funcionario`) REFERENCES `funcionario` (`id`)
...
INSERT INTO `caixa` VALUES (1,200,600,30,1,1),(2,300,800,25,1,2);
